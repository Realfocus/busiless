...
const SignupSupervisor = () => {
  ...
  const validateForm = () => {
    ...
    if (formData.calendly && !formData.calendly.includes("calendly.com")) {
      newErrors.calendly = "Please enter a valid Calendly URL"
    }
  ...
  return (
    <div className="bg-gray-100 flex flex-col justify-center sm:px-6 lg:px-8 py-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Supervisor Signup - Busiless</h2>
      </div>
          ...
          {loading && groups.length === 0 ? (
            ...
            <form className="space-y-6" onSubmit={handleSubmit} noValidate>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      onChange={handleChange}
                      className={`appearance-none block w-full px-3 py-2 border ${errors.specialisation ? "border-red-500" : "border-gray-300"
                        } rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
                ...
                {/* Calendly */}
                <div>
                  <label htmlFor="calendly" className="block text-sm font-medium text-gray-700">
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      onChange={handleChange}
                      className={`appearance-none block w-full px-3 py-2 border ${errors.calendly ? "border-red-500" : "border-gray-300"
                        } rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
                      placeholder="https://calendly.com/your-username"
                    />
                    {errors.calendly && <p className="mt-1 text-sm text-red-600">{errors.calendly}</p>}
                  </div>
                </div>
              </div>
